...
Occlusion = 0.1;
GauNoiseSig = 25;
userName = ['Windows' '_Occlusion' num2str(Occlusion) '_GauNoise' num2str(GauNoiseSig)];
para.optmet = 'ADMPG';  % the used method for optimization
para.pFlag = 1; 
...
para.maxIter = 50; % maximum iteration number of main loops   25

% inner loop
para.inner_tol = [1e-5 1e-8];
para.muBound = 1e-30;
